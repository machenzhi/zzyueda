			...
			<div class="am-cf">
				...
				<ul
					...
					<li id="firstPage"
						...
						<a
						href="${basePath}news/qiantai/getNewsImgList.do?typename=${page.typename}&typeid=${page.typeid}&typepath=${page.typepath}&currentPage=1&htmlName=${page.typeid}_1"
						<c:if test="${page.currentPage==1}">disabled="disabled"</c:if>>首页</a>
					</li>
					<li id="previousPage"
						<c:if test="${page.currentPage==1}">class="am-disabled"</c:if>>
						<a
						href="${basePath}news/qiantai/getNewsImgList.do?typename=${page.typename}&typeid=${page.typeid}&typepath=${page.typepath}&currentPage=${page.currentPage-1<1?1:page.currentPage-1}&htmlName=${page.typeid}_${page.currentPage-1<1?1:page.currentPage-1}"
					...
					<li id="nextPage"
						...
						<a
						href="${basePath}news/qiantai/getNewsImgList.do?typename=${page.typename}&typeid=${page.typeid}&typepath=${page.typepath}&currentPage=${page.currentPage+1<=page.totalPage?page.currentPage+1:page.totalPage}&htmlName=${page.typeid}_${page.currentPage+1<=page.totalPage?page.currentPage+1:page.totalPage}"
						<c:if test="${page.currentPage>=page.totalPage}">disabled="disabled"</c:if>>下一页</a>
					</li>
					<li id="lastPage"
						<c:if test="${page.currentPage>=page.totalPage}">class="am-disabled"</c:if>>
						<a
						href="${basePath}news/qiantai/getNewsImgList.do?typename=${page.typename}&typeid=${page.typeid}&typepath=${page.typepath}&currentPage=${page.totalPage}&htmlName=${page.typeid}_${page.totalPage}"
